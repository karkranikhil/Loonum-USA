...
export default {
    OUR_STORY_DATA:{
        HERO_DATA: {
            ...
            DESCRIPTION: 'Loonum was co-created by Dananjaya & Nikhil when they aquatinted as colleagues working for a project at RMIT. Both felt how passionate they are doing what they love, creating things to improve people’s lives. Humble coffee catch-ups and talking hours on how they want to design & build products that have value led to this great venture. With over 15 years of global design & development experience, they’ve been delivering valued outcomes to major organisations. '
        },
        FOUNDER_DATA: [
            {
                img: DANANJAYA_IMG,
            ...
            },
            {
                ...
                description1: "Nikhil’s passion for creating truly beautiful, efficient digital products makes people’s experiences memorable. He is an individual with high standards for everything that comes his way. Always eager to learn new technology when global tech giants test them as he will be someone always prepared for what comes next. He is someone who never accepts limitations in technology. Always find a way to solve the problem at hand. He has been a mentor for many in the industry. You can follow his video lectures on youtube as well as a written article on medium.",
                description2: "He is a mountaineer, climbed over 5000m elevation in the Himalayas, and has a great love for nature. He loves cooking favorite cuisines, and his kitchen happens to be his playground. Nikhil’s open for any idea or thought you have to discuss over a cup of tea."
            }
        ]
    }
